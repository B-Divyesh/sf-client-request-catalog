...
Audited 2026-08-30. Word counts treat hyphenated terms as one word. No line is
over 22 words and no banned term appears.
...
| Create a client link. | 4 |
| Name the client and choose when access ends. | 8 |
| Share the catalog. | 3 |
